...
[LinkedIn](https://www.linkedin.com/in/burgerjoseph/) ⚬ [GitHub](https://github.com/candyapplecorn) ⚬ [Personal Page](https://candyapplecorn.github.io/portfolio/) ⚬ [Resume](https://candyapplecorn.github.io/joseph_burger_resume_2023_05_16_reduced_pii.pdf)

## SKILLS

Typescript, JavaScript, NodeJS, Kotlin, Python, Bash, C/C++, Java, PHP, Perl, React, Express, Vue, Ruby on Rails, HTML5, CSS3, SQL, Kotlin, Docker, AWS, Docker, Git, Linux, SQL, Redis
